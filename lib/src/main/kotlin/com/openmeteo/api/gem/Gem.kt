...
object Gem {
    ...
    val context = URL("https://api.open-meteo.com/v1/gem")

    open class Query(
        override val latitude: Float,
        override val longitude: Float,
        override val hourly: Iterable<GemHourly>? = null,
        override val daily: Iterable<GemDaily>? = null,
    ...
    open class Response(
        ...
        override val hourlyUnits: Map<GemHourly, Unit> = emptyMap(),
        @SerialName("hourly")
        override val hourlyValues: Map<GemHourly, Array<Double?>> = emptyMap(),
        @SerialName("daily_units")
        override val dailyUnits: Map<GemDaily, Unit> = emptyMap(),
        @SerialName("daily")
        override val dailyValues: Map<GemDaily, Array<Double?>> = emptyMap(),
