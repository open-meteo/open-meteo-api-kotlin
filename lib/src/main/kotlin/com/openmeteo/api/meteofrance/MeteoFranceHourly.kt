...
@Serializable
enum class MeteoFranceHourly : Options {
    @SerialName("time")
    Time,
    ...
    @SerialName("relativehumidity_125hPa")
    Relativehumidity125hPa,
    ...
    Winddirection150hPa,
    @SerialName("winddirection_125hPa")
    Winddirection125hPa,
    ...
    @SerialName("geopotential_height_125hPa")
    GeopotentialHeight125hPa,
