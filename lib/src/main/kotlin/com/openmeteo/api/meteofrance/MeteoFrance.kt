package com.openmeteo.api.meteofrance
...
object MeteoFrance {
    ...
    open class Query(
        ...
        override val hourly: Iterable<MeteoFranceHourly>? = null,
        override val daily: Iterable<MeteoFranceDaily>? = null,
    ...
    open class Response(
        ...
        override val hourlyUnits: Map<MeteoFranceHourly, Unit> = emptyMap(),
        @SerialName("hourly")
        override val hourlyValues: Map<MeteoFranceHourly, Array<Double?>> = emptyMap(),
        @SerialName("daily_units")
        override val dailyUnits: Map<MeteoFranceDaily, Unit> = emptyMap(),
        @SerialName("daily")
        override val dailyValues: Map<MeteoFranceDaily, Array<Double?>> = emptyMap(),
